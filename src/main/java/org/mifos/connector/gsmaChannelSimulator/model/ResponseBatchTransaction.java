...
public class ResponseBatchTransaction   {
  ...
  @Size(min=1,max=256)   public String getBatchId() {
    return batchId;
  }
  ...
  @Schema(description = "Indicates the number of records that have been successful completed.")
    ...
    @Valid
  @DecimalMin("0")  public BigDecimal getCompletedCount() {
    return completedCount;
  }
  ...
  @Schema(description = "Indicates the number of records that have been rejected, either during parsing or during final processing.")
    ...
    @Valid
  @DecimalMin("0")  public BigDecimal getRejectionCount() {
    return rejectionCount;
  }
  ...
  @Schema(description = "Indicates the number of records that have been parsed successfully.")
    ...
    @Valid
  @DecimalMin("0")  public BigDecimal getParsingSuccessCount() {
    return parsingSuccessCount;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(batchId, batchStatus, approvalDate, completionDate, batchTitle, batchdescription, processingFlag, completedCount, rejectionCount, parsingSuccessCount, requestingOrganisation, scheduledStartDate, creationDate, modificationDate, requestDate, customData, completedDate);
  }
