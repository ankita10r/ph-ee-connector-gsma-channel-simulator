...
public class RequestAuthorisationCode   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, currency, amountType, codeLifetime, holdFundsIndicator, redemptionAccountIdentifiers, redemptionChannels, redemptionTransactionTypes, requestingOrganisation, requestDate, customData, metadata);
  }
