...
public class ResponseAuthorisationCode   {
  ...
  @Size(max=256)   public String getAuthorisationCode() {
    return authorisationCode;
  }
  ...
  @Schema(example = "600", description = "Indicates the expiry time in seconds of the code.")
    ...
    @Valid
  @DecimalMin("1")  public BigDecimal getCodeLifetime() {
    return codeLifetime;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorisationCode, codeState, amount, currency, amountType, codeLifetime, holdFundsIndicator, redemptionAccountIdentifiers, redemptionChannels, redemptionTransactionTypes, requestingOrganisation, creationDate, modificationDate, requestDate, customData, metadata);
  }
