...
public class Quotes   {
  ...
  @Pattern(regexp="^([0]|([1-9][0-9]{0,17}))([.][0-9]{0,3}[0-9])?$") @Size(min=1,max=23)   public String getReceivingAmount() {
    return receivingAmount;
  }
  ...
  @Pattern(regexp="^([0]|([1-9][0-9]{0,17}))([.][0-9]{0,3}[0-9])?$") @Size(min=1,max=23)   public String getSendingAmount() {
    return sendingAmount;
  }
  ...
  @Pattern(regexp="^([0]|([1-9][0-9]{0,17}))([.][0-9]{0,10}[1-9])?$") @Size(min=4,max=256)   public String getFxRate() {
    return fxRate;
  }
  ...
  @Size(max=256)   public String getReceivingServiceProvider() {
    return receivingServiceProvider;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.quoteId, quotes.quoteId) &&
        Objects.equals(this.receivingAmount, quotes.receivingAmount) &&
        Objects.equals(this.receivingCurrency, quotes.receivingCurrency) &&
        Objects.equals(this.sendingAmount, quotes.sendingAmount) &&
        Objects.equals(this.sendingCurrency, quotes.sendingCurrency) &&
        Objects.equals(this.deliveryMethod, quotes.deliveryMethod) &&
        Objects.equals(this.fees, quotes.fees) &&
        Objects.equals(this.fxRate, quotes.fxRate) &&
        Objects.equals(this.quoteExpiryTime, quotes.quoteExpiryTime) &&
        Objects.equals(this.receivingServiceProvider, quotes.receivingServiceProvider);
  }

  @Override
  public int hashCode() {
    return Objects.hash(quoteId, receivingAmount, receivingCurrency, sendingAmount, sendingCurrency, deliveryMethod, fees, fxRate, quoteExpiryTime, receivingServiceProvider);
  }
