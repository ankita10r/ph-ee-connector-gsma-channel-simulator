...
public class ResponseBills   {
  ...
  @Size(max=256)   public String getBillReference() {
    return billReference;
  }
  ...
  @Pattern(regexp="^([0]|([1-9][0-9]{0,17}))([.][0-9]{0,3}[0-9])?$") @Size(min=1,max=23)   public String getAmountDue() {
    return amountDue;
  }
  ...
  @Size(max=256)   public String getBilldescription() {
    return billdescription;
  }
  ...
  @Pattern(regexp="^([0]|([1-9][0-9]{0,17}))([.][0-9]{0,3}[0-9])?$") @Size(min=1,max=23)   public String getMinimumAmountDue() {
    return minimumAmountDue;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billReference, responseBills.billReference) &&
        Objects.equals(this.billStatus, responseBills.billStatus) &&
        Objects.equals(this.amountDue, responseBills.amountDue) &&
        Objects.equals(this.currency, responseBills.currency) &&
        ...
        Objects.equals(this.customData, responseBills.customData) &&
        Objects.equals(this.metadata, responseBills.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(billReference, billStatus, amountDue, currency, billdescription, dueDate, minimumAmountDue, creationDate, modificationDate, customData, metadata);
  }
