...
public class ResponseBatchTransactionCompletion   {
  ...
  public ResponseBatchTransactionCompletion requestingOrganisationTransactionReference(String requestingOrganisationTransactionReference) {
  ...
  @Size(min=1,max=256)   public String getLink() {
    return link;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionReference, requestingOrganisationTransactionReference, creditParty, debitParty, completionDate, link, customData, completedDate);
  }
