...
public class ResponseBillPayment   {
  ...
  public ResponseBillPayment serviceProviderPaymentReference(String serviceProviderPaymentReference) {
  ...
  public ResponseBillPayment requestingOrganisationTransactionReference(String requestingOrganisationTransactionReference) {
  ...
  public ResponseBillPayment customerReference(String customerReference) {
  ...
  public ResponseBillPayment paymentType(PaymentType paymentType) {
  ...
  public ResponseBillPayment billPaymentStatus(String billPaymentStatus) {
  ...
  @Size(max=256)   public String getBillPaymentStatus() {
    return billPaymentStatus;
  }
  ...
  public ResponseBillPayment amountPaid(String amountPaid) {
  ...
  public ResponseBillPayment currency(Currency currency) {
  ...
  public ResponseBillPayment requestingOrganisation(String requestingOrganisation) {
  ...
  public ResponseBillPayment serviceProviderComment(String serviceProviderComment) {
  ...
  @Size(max=256)   public String getServiceProviderComment() {
    return serviceProviderComment;
  }
  ...
  public ResponseBillPayment serviceProviderNotification(String serviceProviderNotification) {
  ...
  @Size(max=256)   public String getServiceProviderNotification() {
    return serviceProviderNotification;
  }
  ...
  public ResponseBillPayment requestDate(OffsetDateTime requestDate) {
  ...
  public ResponseBillPayment creationDate(OffsetDateTime creationDate) {
  ...
  public ResponseBillPayment modificationDate(OffsetDateTime modificationDate) {
  ...
  public ResponseBillPayment customData(CustomDataArray customData) {
  ...
  public ResponseBillPayment metadata(MetadataArray metadata) {
  ...
  public ResponseBillPayment paidAmount(String paidAmount) {
  ...
  public boolean equals(Object o) {
    ...
    ResponseBillPayment responseBillPayment = (ResponseBillPayment) o;
    return Objects.equals(this.serviceProviderPaymentReference, responseBillPayment.serviceProviderPaymentReference) &&
        Objects.equals(this.requestingOrganisationTransactionReference, responseBillPayment.requestingOrganisationTransactionReference) &&
        Objects.equals(this.customerReference, responseBillPayment.customerReference) &&
        Objects.equals(this.paymentType, responseBillPayment.paymentType) &&
        Objects.equals(this.billPaymentStatus, responseBillPayment.billPaymentStatus) &&
        Objects.equals(this.amountPaid, responseBillPayment.amountPaid) &&
        Objects.equals(this.currency, responseBillPayment.currency) &&
        Objects.equals(this.requestingOrganisation, responseBillPayment.requestingOrganisation) &&
        Objects.equals(this.supplementaryBillReferenceDetails, responseBillPayment.supplementaryBillReferenceDetails) &&
        Objects.equals(this.serviceProviderComment, responseBillPayment.serviceProviderComment) &&
        Objects.equals(this.serviceProviderNotification, responseBillPayment.serviceProviderNotification) &&
        Objects.equals(this.requestDate, responseBillPayment.requestDate) &&
        Objects.equals(this.creationDate, responseBillPayment.creationDate) &&
        Objects.equals(this.modificationDate, responseBillPayment.modificationDate) &&
        Objects.equals(this.customData, responseBillPayment.customData) &&
        Objects.equals(this.metadata, responseBillPayment.metadata) &&
        Objects.equals(this.paidAmount, responseBillPayment.paidAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceProviderPaymentReference, requestingOrganisationTransactionReference, customerReference, paymentType, billPaymentStatus, amountPaid, currency, requestingOrganisation, supplementaryBillReferenceDetails, serviceProviderComment, serviceProviderNotification, requestDate, creationDate, modificationDate, customData, metadata, paidAmount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ResponseBillPayment {\n");
