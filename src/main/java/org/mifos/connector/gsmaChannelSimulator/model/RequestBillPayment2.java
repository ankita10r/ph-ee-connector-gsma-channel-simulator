...
public class RequestBillPayment2   {
  ...
  public RequestBillPayment2 serviceProviderPaymentReference(String serviceProviderPaymentReference) {
  ...
  public RequestBillPayment2 requestingOrganisationTransactionReference(String requestingOrganisationTransactionReference) {
  ...
  public RequestBillPayment2 paymentType(PaymentType paymentType) {
  ...
  public RequestBillPayment2 amountPaid(String amountPaid) {
  ...
  public RequestBillPayment2 currency(Currency currency) {
  ...
  public RequestBillPayment2 customerReference(String customerReference) {
  ...
  public RequestBillPayment2 requestDate(OffsetDateTime requestDate) {
  ...
  public RequestBillPayment2 customData(CustomDataArray customData) {
  ...
  public RequestBillPayment2 metadata(MetadataArray metadata) {
  ...
  public RequestBillPayment2 paidAmount(String paidAmount) {
  ...
  public boolean equals(Object o) {
    ...
    RequestBillPayment2 requestBillPayment2 = (RequestBillPayment2) o;
    return Objects.equals(this.serviceProviderPaymentReference, requestBillPayment2.serviceProviderPaymentReference) &&
        Objects.equals(this.requestingOrganisationTransactionReference, requestBillPayment2.requestingOrganisationTransactionReference) &&
        Objects.equals(this.paymentType, requestBillPayment2.paymentType) &&
        Objects.equals(this.amountPaid, requestBillPayment2.amountPaid) &&
        Objects.equals(this.currency, requestBillPayment2.currency) &&
        Objects.equals(this.customerReference, requestBillPayment2.customerReference) &&
        Objects.equals(this.requestingOrganisation, requestBillPayment2.requestingOrganisation) &&
        Objects.equals(this.requestDate, requestBillPayment2.requestDate) &&
        Objects.equals(this.customData, requestBillPayment2.customData) &&
        Objects.equals(this.metadata, requestBillPayment2.metadata) &&
        Objects.equals(this.paidAmount, requestBillPayment2.paidAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceProviderPaymentReference, requestingOrganisationTransactionReference, paymentType, amountPaid, currency, customerReference, requestingOrganisation, requestDate, customData, metadata, paidAmount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RequestBillPayment2 {\n");
