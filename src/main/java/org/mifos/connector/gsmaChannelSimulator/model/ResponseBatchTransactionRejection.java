...
public class ResponseBatchTransactionRejection   {
  ...
  @Size(min=1,max=256)   public String getRejectionReason() {
    return rejectionReason;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transactionReference, responseBatchTransactionRejection.transactionReference) &&
        Objects.equals(this.requestingOrganisationTransactionReference, responseBatchTransactionRejection.requestingOrganisationTransactionReference) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionReference, requestingOrganisationTransactionReference, creditParty, debitParty, rejectionReason, rejectionDate, customData, dateRejected);
  }
