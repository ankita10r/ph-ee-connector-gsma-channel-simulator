...
public class ResponseAccountStatus   {
  ...
  @Size(max=256)   public String getSubStatus() {
    return subStatus;
  }
  ...
  @Pattern(regexp="^[A-Z0-9]{4}00[A-Z0-9]{12}\\d{2}$") @Size(max=20)   public String getLei() {
    return lei;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountStatus, responseAccountStatus.accountStatus) &&
        Objects.equals(this.subStatus, responseAccountStatus.subStatus) &&
        Objects.equals(this.lei, responseAccountStatus.lei);
  }
