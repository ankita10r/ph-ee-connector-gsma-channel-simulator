...
public class RequestDebitMandate   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(payee, mandateStatus, amountLimit, currency, startDate, endDate, frequencyType, numberOfPayments, requestingOrganisation, requestDate, customData);
  }
