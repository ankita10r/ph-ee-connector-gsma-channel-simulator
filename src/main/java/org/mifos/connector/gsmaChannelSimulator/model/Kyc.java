...
public class Kyc   {
  ...
  @Size(max=256)   public String getContactPhone() {
    return contactPhone;
  }
  ...
  @Size(max=256)   public String getEmailAddress() {
    return emailAddress;
  }
  ...
  @Size(max=256)   public String getEmployerName() {
    return employerName;
  }
  ...
  @Size(max=256)   public String getOccupation() {
    return occupation;
  }
  ...
  public boolean equals(Object o) {
    ...
    Kyc kyc = (Kyc) o;
    return Objects.equals(this.birthCountry, kyc.birthCountry) &&
        Objects.equals(this.contactPhone, kyc.contactPhone) &&
        Objects.equals(this.dateOfBirth, kyc.dateOfBirth) &&
        Objects.equals(this.emailAddress, kyc.emailAddress) &&
        Objects.equals(this.employerName, kyc.employerName) &&
        Objects.equals(this.gender, kyc.gender) &&
        Objects.equals(this.idDocument, kyc.idDocument) &&
        Objects.equals(this.nationality, kyc.nationality) &&
        Objects.equals(this.occupation, kyc.occupation) &&
        Objects.equals(this.postalAddress, kyc.postalAddress) &&
        Objects.equals(this.subjectName, kyc.subjectName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(birthCountry, contactPhone, dateOfBirth, emailAddress, employerName, gender, idDocument, nationality, occupation, postalAddress, subjectName);
  }
