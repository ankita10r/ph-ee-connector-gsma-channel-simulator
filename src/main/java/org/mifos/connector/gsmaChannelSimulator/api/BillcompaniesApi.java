...
import org.mifos.connector.gsmaChannelSimulator.model.ErrorObject;
...
public interface BillcompaniesApi {
    ...
    @Operation(summary = "View a Specific Bill Company", description = "This Bill Companies API is used to return a information for a specific Service Providers that accepts Bill Payments.", tags={ "Bills" })
    @ApiResponses(value = { 
