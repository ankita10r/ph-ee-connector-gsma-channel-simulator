...
import org.mifos.connector.gsmaChannelSimulator.configuration.CustomInstantDeserializer;
import org.mifos.connector.gsmaChannelSimulator.configuration.LocalDateConverter;
import org.mifos.connector.gsmaChannelSimulator.configuration.LocalDateTimeConverter;
...
@OpenAPIDefinition(info = @Info(title = "GSMA Channel Simulator connector APIs"))
public class GsmaChannelSimulatorApplication {
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(GsmaChannelSimulatorApplication.class, args);
	}
